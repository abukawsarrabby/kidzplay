...
const Footer = () => {
    return (
        <footer>
            <div className="footer md:px-24 mt-10 p-10 bg-base-200 text-base-content">
                <div>
                    ...
                    <p className='md:ml-5'>Providing reliable toy market since 2019</p>
                </div>
                <div>
            ...
            <div className="flex justify-between p-10 md:px-28 items-center bg-neutral text-neutral-content">
                <div className="items-center grid-flow-col md:ml-5">
                    <p>Copyright © {moment().format('YYYY')} - All right reserved</p>
                </div>
                <div className="flex gap-4 md:place-self-center md:justify-self-end md:mr-5">
